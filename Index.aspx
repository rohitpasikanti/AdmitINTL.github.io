<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="edu.Index" %>
...
<body>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="img/hero-slider/college2.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<%--<div class="hs-subtitle">ABROAD UNIVERSITY</div>--%>
								<h2 class="hs-title">College Application,Improbable Yes,Impossible No.</h2>
								<p class="hs-des">There is no end to education it is not that you read a book, Pass an examination and finish with education.<br> The whole life,from the movement you born to the movement you die is a process of learning</p>
			...
			<div class="hs-item set-bg" data-setbg="img/hero-slider/ppeople1.jpg">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<%--<div class="hs-subtitle">ABROAD UNIVERSITY</div>--%>
								<h2 class="hs-title">You Become What You Study.</h2>
								<p class="hs-des">There is no end to education it is not that you read a book, Pass an examination and finish with education.<br> The whole life,from the movement you born to the movement you die is a process of learning</p>
								<div class="site-btn">GET STARTED</div>
							</div>
						</div>
	...
	<section class="service-section spad">
		<div class="container services">
			<div class="section-title text-center">
				<h3>OUR SERVICES</h3>
				<p>We provides wolrd class education</p>
			</div>
			<div class="row">
